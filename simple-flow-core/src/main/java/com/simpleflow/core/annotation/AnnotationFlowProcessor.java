...
public class AnnotationFlowProcessor {
    ...
    private void processClass(String className) {
        try {
            ...
            if (clazz.isAnnotationPresent(com.simpleflow.core.annotation.FlowDefinition.class)) {
    ...
    private void processFlowDefinition(Class<?> clazz) {
        com.simpleflow.core.annotation.FlowDefinition flowAnnotation = 
            clazz.getAnnotation(com.simpleflow.core.annotation.FlowDefinition.class);
