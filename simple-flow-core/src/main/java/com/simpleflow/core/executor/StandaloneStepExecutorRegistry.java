...
import com.simpleflow.api.ExecutableNode;
import com.simpleflow.api.ServiceRegistry;
import com.simpleflow.core.registry.DefaultServiceRegistry;
...
public class StandaloneStepExecutorRegistry {
    ...
    private void registerDefaultExecutors() {
        try {
            // 注册Bean步骤执行器
            registerExecutor("SERVICE", Class.forName("com.simpleflow.core.executor.StandaloneBeanStepExecutor"));
            // 注册条件步骤执行器
            registerExecutor("CONDITIONAL", Class.forName("com.simpleflow.core.executor.StandaloneConditionalStepExecutor"));
            // 注册ExecutableNode步骤执行器
            registerExecutor("EXECUTABLE_NODE", Class.forName("com.simpleflow.core.executor.ExecutableNodeStepExecutor"));
            // 注册ConditionNode步骤执行器
            registerExecutor("CONDITION_NODE", Class.forName("com.simpleflow.core.executor.ConditionNodeStepExecutor"));
            // 注册注解Bean步骤执行器
            registerExecutor("ANNOTATION_BEAN", Class.forName("com.simpleflow.core.executor.AnnotationBeanStepExecutor"));
