...
public class FlowExecution {
    ...
    private StepResult executeStep(StepDefinition stepDefinition) {
        ...
        try {
            ...
            com.simpleflow.api.StepExecutor executor = (com.simpleflow.api.StepExecutor) clazz.getDeclaredConstructor().newInstance();
            
            log.info("Created executor instance: {} for step: {}", executor.getClass().getSimpleName(), stepDefinition.getId());
            
            // 创建流程上下文
            com.simpleflow.api.FlowContext context = createFlowContext(stepDefinition);
    ...
    private String determineExecutorByBeanType(StepDefinition stepDefinition) {
        ...
        if (stepDefinition.getType() == StepDefinition.StepType.SERVICE) {
            return "com.simpleflow.core.executor.StandaloneBeanStepExecutor";
        } else if (stepDefinition.getType() == StepDefinition.StepType.CONDITIONAL) {
            return "com.simpleflow.core.executor.StandaloneConditionalStepExecutor";
    ...
    private String determineExecutorByNodeType(String nodeName) {
        com.simpleflow.core.executor.StandaloneStepExecutorRegistry registry = 
            com.simpleflow.core.executor.StandaloneStepExecutorRegistry.getInstance();
        
        // 检查是否为ExecutableNode
        if (registry.hasExecutableNode(nodeName)) {
            return "com.simpleflow.core.executor.ExecutableNodeStepExecutor";
        }
        
        // 检查是否为ConditionNode
        if (registry.hasConditionNode(nodeName)) {
            return "com.simpleflow.core.executor.ConditionNodeStepExecutor";
        }
    ...
    private String determineExecutorByBeanName(String beanName) {
        ...
        // 检查bean类型
        if (beanInstance instanceof com.simpleflow.api.ExecutableNode) {
            return "com.simpleflow.core.executor.ExecutableNodeStepExecutor";
        } else if (beanInstance instanceof com.simpleflow.api.ConditionNode) {
            return "com.simpleflow.core.executor.ConditionNodeStepExecutor";
        } else {
     ...
     * @return 流程上下文
     */
    private com.simpleflow.api.FlowContext createFlowContext(StepDefinition stepDefinition) {
     ...
     * 简单的FlowContext实现
     */
    private static class SimpleFlowContext implements com.simpleflow.api.FlowContext {
        ...
        @Override
        public com.simpleflow.api.FlowContext createChildContext(String stepId) {
            return new SimpleFlowContext(currentStep, data);
        }
        
        @Override
        public java.util.Optional<com.simpleflow.api.FlowContext> getParentContext() {
            return java.util.Optional.empty();
        }
        
        @Override
        public com.simpleflow.api.FlowContext copy() {
